...
export default function History() {
  ...
  const renderPlanCard = (plan: SavedPlan) => (
    <Card key={plan.id} className="group transition-all duration-300 border-2 border-primary/30 hover:border-primary/50 hover:shadow-[0_0_20px_rgba(var(--primary-rgb),0.5)]">
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList className="inline-flex w-full max-w-4xl mx-auto gap-2 flex-wrap justify-center">
