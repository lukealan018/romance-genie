        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          >
            ...
            <button
              ...
              className={`relative w-full font-medium py-5 px-6 rounded-[16px] transition-all duration-300 overflow-hidden ${
                isListening 
                  ? 'bg-[rgba(58,122,254,0.18)] border border-[rgba(58,122,254,0.50)] text-[rgba(255,255,255,0.95)]'
                  : loading
                    ? 'bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.15)] text-[rgba(255,255,255,0.90)]'
                    : 'bg-[rgba(58,122,254,0.30)] border border-[rgba(58,122,254,0.70)] hover:bg-[rgba(58,122,254,0.36)] hover:border-[rgba(58,122,254,0.80)] text-[rgba(255,255,255,0.92)]'
              }`}
            >
          ...
          >
            ...
            <button
              ...
              disabled={loading}
              className="relative inline-flex items-center justify-center gap-2 bg-[rgba(58,122,254,0.20)] border border-[rgba(58,122,254,0.55)] hover:bg-[rgba(58,122,254,0.26)] hover:border-[rgba(58,122,254,0.65)] text-[rgba(255,255,255,0.92)] font-medium py-2.5 px-5 rounded-[12px] transition-all duration-200 disabled:opacity-50"
            >
              {loading ? (
                <>
